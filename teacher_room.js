...
const firebaseConfig = {
  ...
  function sendMessage(e) {
    ...
    document
      .getElementById("messages-teachers")
      .scrollIntoView({ behavior: "smooth", block: "end", inline: "nearest" });
  
    // create db collection and send in the data
    db.ref("messages-teachers/" + timestamp).set({
      username,
      message,
    });
  }
  ...
  const fetchChat = db.ref("messages-teachers/");
  ...
  fetchChat.on("child_added", function (snapshot) {
    ...
    document.getElementById("messages-teachers").innerHTML += message;
  });
